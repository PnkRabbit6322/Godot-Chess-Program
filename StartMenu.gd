...
onready var elo_silder = self.get_node("EloSlider")
...
func _on_Start_pressed():
	get_tree().current_scene.get_node("Board").init_stockfish_process(elo_silder.value)
...
func _on_Settings_pressed():
	...
	elo_silder.visible = !elo_silder.visible
